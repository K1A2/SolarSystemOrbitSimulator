...
public class EarthOrbit : MonoBehaviour
{
    public OrbitData[] data = new OrbitData[]{
        new OrbitData(1.00000261d, 0.01671123d, -0.00001531d, 0.0d, 100.46457166d, 102.93768193d, 0d, 0d, 0d, 0d, 0d),
        new OrbitData(0.00000562d,  -0.00004392d,-0.01294668d, 0.0d, 35999.37244981d, 0.32327364d, 0d, 0d, 0d, 0d, 0d),
    ...
    void Update() {
        ...
        GameObject.Find("E").transform.position = Camera.main.WorldToScreenPoint(this.transform.position);
        if (dropdown2.selected == 3) {
