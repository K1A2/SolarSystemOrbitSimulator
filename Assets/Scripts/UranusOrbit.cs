...
public class UranusOrbit : MonoBehaviour
{
    public OrbitData[] data = new OrbitData[]{
        new OrbitData(19.18916464d,0.04725744d,   0.77263783d,  74.01692503d, 313.23810451d, 170.95427630d, 0d, 0d, 0d, 0d, 0d),
        new OrbitData(-0.00196176d,  -0.00004397d, -0.00242939d,0.04240589d,  428.48202785d, 0.40805281d, 0d, 0d, 0d, 0d, 0d),
    ...
    void Update() {
        ...
        GameObject.Find("U").transform.position = Camera.main.WorldToScreenPoint(this.transform.position);
        if (dropdown2.selected == 7) {
