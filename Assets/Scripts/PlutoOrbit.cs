...
public class PlutoOrbit : MonoBehaviour
{
    public OrbitData[] data = new OrbitData[]{
        new OrbitData(39.48211675d,0.24882730d,  17.14001206d, 110.30393684d,  238.92903833d, 224.06891629d, 0d, 0d, 0d, 0d, 0d),
        new OrbitData( -0.00031596d,  0.00005170d, 0.00004818d, -0.01183482d, 145.20780515d,-0.04062942d, 0d, 0d, 0d, 0d, 0d),
    ...
    void Update() {
        ...
        GameObject.Find("P").transform.position = Camera.main.WorldToScreenPoint(this.transform.position);
        if (dropdown2.selected == 9) {
