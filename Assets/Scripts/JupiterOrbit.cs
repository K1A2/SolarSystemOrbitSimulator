...
public class JupiterOrbit : MonoBehaviour
{
    public OrbitData[] data = new OrbitData[]{
        new OrbitData(5.20288700d,0.04838624d,  1.30439695d, 100.47390909d, 34.39644051d, 14.72847983d, 0d, 0d, 0d, 0d, 0d),
        new OrbitData(-0.00011607d,  -0.00013253d, -0.00183714d, 0.20469106d, 3034.74612775d, 0.21252668d, 0d, 0d, 0d, 0d, 0d),
    ...
    void Update() {
        ...
        GameObject.Find("J").transform.position = Camera.main.WorldToScreenPoint(this.transform.position);
        if (dropdown2.selected ==5) {
