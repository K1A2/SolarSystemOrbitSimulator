...
public class VenusOrbit : MonoBehaviour
{
    public OrbitData[] data = new OrbitData[]{
        new OrbitData(0.72333566d, 0.00677672d, 3.39467605d, 76.67984255d, 181.97909950d, 131.60246718d, 0d, 0d, 0d, 0d, 0d),
        new OrbitData(0.00000390d,  -0.00004107d,-0.00078890d, -0.27769418d, 58517.81538729d, 0.00268329d, 0d, 0d, 0d, 0d, 0d),
    ...
    void Update() {
        ...
        GameObject.Find("V").transform.position = Camera.main.WorldToScreenPoint(this.transform.position);
        if (dropdown2.selected == 2) {
